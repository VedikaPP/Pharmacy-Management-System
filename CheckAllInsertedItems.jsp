...
<html>
 ...
 <li><a href="CheckAllInsertedItems.jsp">Check Medicine</a></li>
  ...
  <li><a href="index.jsp">Logout</a></li>
            ...
            <div class="login-box">
          <center>
             <form method="POST" action="CheckAllInsertedItems.jsp">
            <fieldset>
                <table>
                    <b><h1></h1><b>
                ...
                <table>
                    <b><h1>Insert Data</h1><b>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><input type="text" readonly="readonly" name="name" value="<%= rs.getString("Name")%>"  placeholder="Enter Product name" required></td>
                            </tr>
                            <tr>
                                <td style="color:white">Enter Purchasing Shop name</td>
                                <td>:</td>
                                <td><input type="text" readonly="readonly" name="sname" value="<%= rs.getString("ShopName")%>"  placeholder="Enter Purchasing shop name" required></td>
                            </tr>
                            <tr>
                                <td style="color:white">Purchasing Shop Contact no</td>
                                <td>:</td>
                                <td><input type="text" readonly="readonly" name="psno"value="<%= rs.getString("ShopContactNo")%>"placeholder="Enter Purchasing shop contact no" pattern="[7-9]{1}[0-9]{9}" 
       title="Phone number with 7-9 and remaing 9 digit with 0-9"  required></td>
                            </tr>
                            <tr>
                                <td style="color:white">product Color</td>
                                <td>:</td>
                                <td><select name="color" readonly="readonly" value="<%= rs.getString("Color")%>">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><input type="text" name="qty" disabled="disabled" readonly="readonly" value="<%= rs.getString("Qty")%>"  placeholder="Enter product quantity " pattern="[0-9]{1,}" title="Enter at least 1 digit " required></td>
                            </tr>
                            <tr>
                                <td style="color:white">Purchasing Price</td>
                                <td>:</td>
                                <td><input type="text" name="pprate" readonly="readonly" value="<%= rs.getString("Pprate")%>"  placeholder="Enter Purchasing rate" pattern="[0-9]{1,}" title="Enter at least 1 digit " required></td>
                            </tr>
                            <tr>
                                <td style="color:white">GST</td>
                                <td>:</td>
                                <td><input type="text" name="gst" readonly="readonly" value="<%= rs.getString("Gst")%>"  placeholder="Enter GST amount" pattern="[0-9]{1,}" title="Enter at least 1 digit " required></td>
                            </tr>
                            <tr>
                                <td style="color:white">Selling price</td>
                                <td>:</td>
                        <td><input type="text" name="srate" readonly="readonly" value="<%= rs.getString("Srate")%>"  placeholder="Enter selling Price" pattern="[0-9]{1,}" title="Enter at least 1 digit " required></td>
                            </tr>
                             <tr>
                                <td style="color:white">purchasing date</td>
                                <td>:</td>
                        <td><input type="date" name="pdate" readonly="readonly" value="<%= rs.getString("Pdate")%>" placeholder="Enter selling Price" pattern="[0-9]{1,}" title="Enter at least 1 digit " required></td>
                             </tr>
